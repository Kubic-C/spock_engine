...
namespace spk {
    b2Fixture* comp_sprite_atlasd_t::add_fixture(b2Body* body, float density, float friction, float restitution) {
    ...
    b2Fixture* comp_sprite_arrayd_t::add_fixture(b2Body* body, float density, float friction, float restitution) {
        b2PolygonShape shape;
        shape.SetAsBox(size.x, size.y);
